...
\descript{Iowa State University (ISU) - Ames, Iowa, USA | Major Professor: Dr. William D. Beavis}
\project{Projects:} Development of
...
\descript{University of São Paulo (USP) - Piracicaba, SP, Brazil | Major Professor: Dr. Antonio A. F. Garcia}
...
\descript{Londrina State University (UEL) - Londrina, PR, Brazil | Major Professor: Dr. Josué M. Ferreira}
...
\project{May 2018 - Present | Department of Agronomy, ISU} \\
%\vspace{\topsep} 
...
\descript{| Graduate research assistant}
\project{March 2016 - March 2018 | Department of Genetics, USP} \\
%\vspace{\topsep} 
...
\project{Jun 2010 - Jun 2015 | Department of Biology, UEL} \\
%\vspace{\topsep} 
...
\begin{tightemize}
	...
	\item \project{2021} Invited to speak in the ``Big Data: Manage your data before your data kills you" session at the Plant and Animal Genome Conference Plant and Animal Genome Conference (PAG) 2022 (declined due to COVID travel restrictions).
	\item \project{2017} Instructor of \emph{R programming} course at USP.
\end{tightemize}

\sectionsep

\descript{Computational Skills}
...
\descript{Leadership}
\begin{tightemize}
	\item \project{2020-2021} Committee member in the 7th and 8th annual R. F. Baker Plant Breeding Symposium at ISU.
...
\hspace{6 cm} \href{https://www.linkedin.com/in/matheus-dalsente-krause-3012b158/}{\includegraphics[scale=0.125]{./logos/lin.jpeg}} \hspace{2 cm} \href{https://about.me/matheusdalsentekrause}{\includegraphics[scale=0.025]{./logos/g.png}} \hspace{2 cm} \href{https://github.com/mdkrause}{\includegraphics[scale=0.06]{./logos/github.png}}
